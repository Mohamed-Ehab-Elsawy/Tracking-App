...
void main() async{
  ...
  testWidgets('test OrdersNumberCard with null data', (WidgetTester tester) async {
  ...
  testWidgets('test OrdersNumberCard with completed state', (WidgetTester tester) async {
  ...
  testWidgets('test OrdersNumberCard with canceled state', (WidgetTester tester) async {
